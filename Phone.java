...
public class Phone implements Serializable {
    ...
    public boolean equals(Object other) {
        return other instanceof ValuePhone && phoneNum.equals(((ValuePhone) other).phoneValue.toString() ) ;
    }
    ...
    /**
    *  Validation for US Phone Number    
    * @param phoneNumber 
    */
    
    public  static Phone validatePhoneNumber(String phoneNumber){
        ...
        if (matcher.matches()){
            if(phoneNumber.charAt(0)=='0'||phoneNumber.charAt(0)=='1'){
                throw DbException.get(ErrorCode.INVALID_PHONE_NUMBER);
            }
